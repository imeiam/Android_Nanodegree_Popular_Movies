...
/**
 * Manages "Authentication" to Sublime's backend service.  The SyncAdapter framework
 ...
 */
public class MovieSensorAuthenticator extends AbstractAccountAuthenticator {

    public MovieSensorAuthenticator(Context context) {
        super(context);
    }
